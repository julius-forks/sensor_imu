...
class Sensor:
    def __init__(self):
        ...
        self.q_covar = rospy.get_param('~q_covar',[0.15,0.15,0.15])
        self.gyro_covar = rospy.get_param('~gyro_covar',[0.15,0.15,0.15])
        self.acc_covar = rospy.get_param('~acc_covar',[0.15,0.15,0.15])
        self.mag_covar = rospy.get_param('~mag_covar',[0.15,0.15,0.15])
